...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
		...
		UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 59.0f, [UIScreen mainScreen].bounds.size.height, 1.0f)];
...
- (void)layoutSubviews {
	...
	self.textLabel.frame = CGRectMake(50.0f, 0.0f, 200.0f, 59.0f);
	self.imageView.frame = CGRectMake(0.0f, 0.0f, 50.0f, 59.0f);
}
